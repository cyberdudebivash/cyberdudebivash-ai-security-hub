...
| Regression rate | **0** — no RESOLVED objection or locked defect has re-observed behavior | Objection Register recurrence check; 1,311-test suite green | Per CEAP sweep + suite |
