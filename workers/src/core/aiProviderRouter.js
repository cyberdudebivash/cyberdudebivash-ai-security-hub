...
export const PROVIDER_CONFIG = {
  ...
  [PROVIDERS.CF_AI]: {
    ...
    models: {
      ...
      red_team:         '@cf/meta/llama-3.1-8b-instruct',
      forensics:        '@cf/meta/llama-3.1-8b-instruct',
      prediction:       '@cf/meta/llama-3.1-8b-instruct',
      threat_intel:     '@cf/meta/llama-3.1-8b-instruct',
      compliance_audit: '@cf/meta/llama-3.1-8b-instruct',
      code_review:      '@cf/meta/llama-3.1-8b-instruct',
    },
    max_tokens_cap: 512,
    timeout_ms:     15000,
    cost_per_1k:    0.00,
