-- schema_bootstrap.sql — canonical single-file schema
...
-- Tables: 228. PRAGMA foreign_keys=OFF during load.
...
CREATE TABLE IF NOT EXISTS ai_posture_scores (
  ...
  overall_score   INTEGER NOT NULL DEFAULT 0,    
  aspm_score      INTEGER NOT NULL DEFAULT 0,    
  governance_score INTEGER NOT NULL DEFAULT 0,   
  redteam_score   INTEGER NOT NULL DEFAULT 0,    
...
CREATE TABLE IF NOT EXISTS brand_threats (
  ...
  ip_address      TEXT,
  mx_records      INTEGER DEFAULT 0,  
  risk_score      INTEGER DEFAULT 0,  
  category        TEXT DEFAULT 'suspicious',  
...
CREATE TABLE IF NOT EXISTS crq_assessments (
  ...
  revenue_usd           REAL,
  annualized_loss_exp   REAL,  
  single_loss_exp       REAL,  
  threat_scenarios      TEXT DEFAULT '[]',  
  top_risk              TEXT,
  risk_band             TEXT,  
  insurance_gap_usd     REAL,  
  control_investment    REAL,  
  roi_security_controls REAL,  
...
CREATE TABLE IF NOT EXISTS mcp_item_scores (
  ...
  click_rate          REAL    NOT NULL DEFAULT 0.0,   
  purchase_rate       REAL    NOT NULL DEFAULT 0.0,   
  ignore_rate         REAL    NOT NULL DEFAULT 0.0,   
  mcp_score           REAL    NOT NULL DEFAULT 50.0,  
  last_updated        TEXT    NOT NULL DEFAULT (datetime('now'))
);
...
CREATE TABLE IF NOT EXISTS mcp_offer_performance (
  ...
  click_rate        REAL    NOT NULL DEFAULT 0.0,
  purchase_rate     REAL    NOT NULL DEFAULT 0.0,
  revenue_per_impression REAL NOT NULL DEFAULT 0.0,        
  best_user_type    TEXT,                                   
  best_context      TEXT,                                   
  best_cta_variant  TEXT,                                   
  revenue_score     REAL    NOT NULL DEFAULT 50.0,          
  last_updated      TEXT    NOT NULL DEFAULT (datetime('now'))
);
...
CREATE TABLE IF NOT EXISTS mcp_revenue_events (
  ...
  discount_pct     INTEGER DEFAULT 0,                       
  cta_variant      TEXT    DEFAULT 'standard',              
...
CREATE TABLE IF NOT EXISTS mssp_partners (
  ...
  created_at    INTEGER NOT NULL DEFAULT (unixepoch()),
  metadata      TEXT DEFAULT '{}'
, partner_share_pct REAL NOT NULL DEFAULT 60.0);
...
CREATE TABLE IF NOT EXISTS service_orders (
  ...
  requirements        TEXT,                             
  assessment_inputs   TEXT DEFAULT '{}',                
...
CREATE TABLE IF NOT EXISTS services (
  ...
  delivery_hours      INTEGER DEFAULT 72,               
  automated_engine    TEXT,                             
...
CREATE TABLE IF NOT EXISTS threat_intel (
  ...
  updated_at      TEXT    NOT NULL DEFAULT (datetime('now'))
, actively_exploited, created_at, epss_score, exploit_status, known_ransomware, cvss, threat_class TEXT, solution_generated INTEGER DEFAULT 0, source_url TEXT, tags TEXT DEFAULT '[]', affected_products TEXT DEFAULT '[]', weakness_types TEXT DEFAULT '[]', enriched INTEGER DEFAULT 0);
...
CREATE TABLE IF NOT EXISTS tprm_vendors (
  ...
  assessment_findings TEXT DEFAULT '[]',     
...
CREATE TABLE IF NOT EXISTS user_profiles (
  ...
  preferred_bundles   TEXT    DEFAULT '[]',       
  risk_pattern        TEXT    DEFAULT 'unknown',  
  conversion_behavior TEXT    DEFAULT 'unknown',  
  top_module          TEXT,                       
