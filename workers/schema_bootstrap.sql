...
-- Tables: 247. PRAGMA foreign_keys=OFF during load.
-- (2026-07-16: synced 4 tables + 1 column that had drifted from production
-- since v50/v51 migrated live without a bootstrap regen — see issue #275.)
...
,
  ...
  created_at TEXT
, threat_class TEXT, solution_generated INTEGER DEFAULT 0);
