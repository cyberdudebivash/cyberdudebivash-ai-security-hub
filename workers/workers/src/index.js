...
<p style="margin-top:16px"><a href="https://cyberdudebivash.in">← Return to Sentinel APEX</a></p>
  ...
  if (path === '/api/subscription/plan' && method === 'GET') {
    ...
    // Returns { country, currency, symbol } from Cloudflare CF-IPCountry header.
    // Used by geo-currency-router.js client for async country refresh.
    // Cached 1h at edge. Zero-auth, public endpoint.
